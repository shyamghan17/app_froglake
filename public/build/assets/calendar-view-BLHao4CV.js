import{j as i}from"./ui-B-PA_g3-.js";import{r as d}from"./vendor-CcMVubkO.js";import{c as b,T as y,D as g,F as h,i as x,a as w}from"./index-v5z11zYu.js";import{u as v}from"./useTranslation-Dp-y6pW6.js";var k=b({name:"@fullcalendar/daygrid",initialView:"dayGridMonth",views:{dayGrid:{component:g,dateProfileGeneratorClass:y},dayGridDay:{type:"dayGrid",duration:{days:1}},dayGridWeek:{type:"dayGrid",duration:{weeks:1}},dayGridMonth:{type:"dayGrid",duration:{months:1},fixedWeekCount:!0},dayGridYear:{type:"dayGrid",duration:{years:1}}}});function T({events:l,onEventClick:r,onDateClick:a,onMonthChange:t}){const{t:o}=v(),[c,f]=d.useState(!1),s=d.useMemo(()=>l.map(e=>{new Date(e.startDate);const n=new Date(e.endDate),u=e.startDate!==e.endDate?new Date(n.getTime()+24*60*60*1e3).toISOString().split("T")[0]:void 0;return{id:e.id.toString(),title:e.title,start:e.startDate,end:u,allDay:!0,backgroundColor:e.color,borderColor:e.color,extendedProps:e}}),[l]),m=e=>{r==null||r(e.event.extendedProps)},p=e=>{a==null||a(new Date(e.dateStr))};return i.jsxs("div",{className:"fullcalendar-container",style:{overflow:"visible"},children:[i.jsx(h,{plugins:[k,x,w],initialView:"dayGridMonth",headerToolbar:{left:"prev,next today",center:"title",right:"dayGridMonth,timeGridWeek,timeGridDay"},events:s,height:"auto",eventClick:m,dateClick:p,datesSet:e=>{if(c){const n=e.start.toISOString().slice(0,7);t==null||t(n)}else f(!0)},dayMaxEventRows:3,moreLinkText:o("more"),allDayText:o("All day"),eventMaxStack:3}),i.jsx("style",{children:`

...
export default function Create() {
    ...
    const calendarFields = useFormFields('getCalendarSyncFields', data, setData, errors, 'create', t, 'Purchase');
    ...
    // Custom fields hook
    const customFields = useFormFields('getCustomFields', { ...data, module: 'General', sub_module: 'Purchase Invoice' }, setData, errors, 'create', t);
    return (
        <AuthenticatedLayout
            breadcrumbs={[

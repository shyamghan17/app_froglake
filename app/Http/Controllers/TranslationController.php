...
class TranslationController extends Controller
{
    ...
    {
        if((auth()->user()->type == 'superadmin') && Auth::user()->can('manage-languages')){
    ...
    {
        if((auth()->user()->type == 'superadmin') && Auth::user()->can('create-languages')){
        ...
        return redirect()->route('languages.manage')->with('error', __('Permission denied'));
    }

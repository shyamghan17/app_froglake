...
import { CreateItemProps, ItemFormData } from './types';

export default function Create({ onSuccess }: CreateItemProps) {
    ...
    const submit = (e: React.FormEvent) => {
        e.preventDefault();
        post(route('ebilling.items.store'), {
            onSuccess: () => {
                onSuccess();
            }
        });
    ...
    return (
        <DialogContent>
            <DialogHeader>
                <DialogTitle>{t('Create Item')}</DialogTitle>
            </DialogHeader>

...
export default function EBillingIndex({ message, stats, recent_items }: EBillingProps) {
    const { t } = useTranslation();
    
    return (
        <AuthenticatedLayout
            breadcrumbs={[{label: t('EBilling')}]}
            pageTitle={t('EBilling Dashboard')}
        >
            <Head title={t('EBilling')} />
            ...
            <Card>
                ...
                <CardContent>
                    <p>{message || t('Welcome to EBilling')}</p>
                </CardContent>
            </Card>
        </AuthenticatedLayout>
    );

            ...
            <Card>
                ...
                <CardContent className="space-y-6">
                    ...
                    <div className="space-y-4">
                        ...
                        <Repeater
                            fields={[
                                { name: 'key', label: t('Module Key'), type: 'text', placeholder: t('taskly'), required: true },
                                { name: 'label', label: t('Module Label'), type: 'text', placeholder: t('Project'), required: true },
                                { name: 'title', label: t('Module Title'), type: 'text', placeholder: t('Project Management System'), required: true },

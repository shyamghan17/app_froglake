...
export default function Screenshots({ settings, title: propTitle, subtitle: propSubtitle, screenshots: propScreenshots }: ScreenshotsProps) {
    ...
    const defaultImages = [
        ...
        '/packages/workdo/LandingPage/src/marketplace/image5.png',
        '/packages/workdo/LandingPage/src/marketplace/image6.png',
                        ...
                        return (
                            ...
                            >
                                <img
                                    src={image.startsWith('http') ? image : getImagePath(image)}
                                    alt={`Screenshot ${index + 1}`}
                                    className={`w-full object-contain group-hover:scale-110 transition-transform duration-700 ${randomHeight}`}
                                />

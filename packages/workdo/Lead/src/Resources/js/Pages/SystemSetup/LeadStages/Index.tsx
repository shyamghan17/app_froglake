...
export default function Index() {
    ...
    const updateStageOrder = (newOrder: number[]) => {
        router.post(route('lead.lead-stages.update-order'), {
            stage_ids: newOrder,
                        ...
                        {auth.user?.permissions?.includes('edit-lead-stages') && (
                            <Tooltip delayDuration={0}>
                                <TooltipTrigger asChild>
                                    <Button variant="ghost" size="sm" onClick={() => openModal('edit', leadstage)} className="h-8 w-8 p-0 text-blue-600 hover:text-blue-700">
                                            ...
                                            {filteredStages
                                                ...
                                                <div
                                                    ...
                                                    onDrop={(e) => {
                                                        ...
                                                        const sortedStages = filteredStages.sort((a: LeadStage, b: LeadStage) => a.order - b.order);

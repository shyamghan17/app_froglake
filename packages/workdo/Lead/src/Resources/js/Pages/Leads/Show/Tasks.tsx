...
export default function Tasks({ lead, onRegisterAddHandler }: TasksProps) {
    ...
    const calendarFields = useFormFields('getCalendarSyncFields', taskForm, (field, value) => {
    ...
    const handleTaskSubmit = (e: React.FormEvent) => {
        e.preventDefault();
        if (editingTask) {
            router.put(route('lead.tasks.update', editingTask.id), taskForm, {
                onSuccess: () => {
            ...
            <Dialog open={taskModalOpen} onOpenChange={(open) => {
                ...
                <DialogContent className="max-w-md">
                    ...
                    <form onSubmit={handleTaskSubmit} className="space-y-4">
                        ...
                        <div className="grid grid-cols-1 gap-6 sm:grid-cols-2">
                            ...
                            <div>
                                ...
                                <TimePicker
                                    ...
                                    required
                                    value={taskForm.time}
                                    onChange={(time) => setTaskForm({...taskForm, time})}
                        ...
                        {/* Calendar Sync Fields - Only show for create form */}
                        ...
                        <div className="flex justify-end gap-2">
                            ...
                            <Button type="submit">{editingTask ? t('Update') : t('Create')}</Button>
                        </div>
                    </form>
                </DialogContent>
            </Dialog>

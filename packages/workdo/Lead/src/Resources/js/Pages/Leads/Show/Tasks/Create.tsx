...
import { CreateTaskProps, LeadTaskFormData } from './types';

export default function Create({ leadId, onSuccess }: CreateTaskProps) {
    const { t } = useTranslation();

    const { data, setData, post, processing, errors, reset } = useForm<LeadTaskFormData>({
        lead_id: leadId,
        name: '',
        date: '',
        time: '',

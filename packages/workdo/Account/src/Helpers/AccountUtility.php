...
class AccountUtility
{
    ...
    private static function createChartOfAccounts($company_id)
    {
        ...
        $chartOfAccounts = [
            ...
            ['type_code' => 'OE', 'account_code' => '5305', 'account_name' => 'Dairy Cattle Expense', 'normal_balance' => 'debit', 'description' => 'Dairy cattle related expenses'],
            ['type_code' => 'OE', 'account_code' => '5306', 'account_name' => 'Catering Expense', 'normal_balance' => 'debit', 'description' => 'Catering related expenses'],

                ...
                try {
                    ...
                    if(!empty($ids))
                    {
                        try {
                            ...
                            {
                                $view->getFactory()->startPush('invoice_payment_tab', view('khalti::payment.sidebar'));
                                $view->getFactory()->startPush('invoice_payment_div', view('khalti::payment.nav_containt_div',compact('type','invoice','company_settings' , 'account')));
                            }
                        } catch (\Throwable $th)
                        {

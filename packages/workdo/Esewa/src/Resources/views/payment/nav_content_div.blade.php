<div class="tab-pane fade" id="esewa-payment" role="tabpanel" aria-labelledby="esewa-payment">
    <form method="post" action="{{route('invoice.pay.with.esewa')}}" class="require-validation" id="payment-form">
        @csrf
        @if($type == 'invoice')

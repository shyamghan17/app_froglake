...
export default function Create({ onSuccess }: CreateAnnouncementProps) {
    ...
    const titleAI = useFormFields('aiField', data, setData, errors, 'create', 'title', 'Title', 'hrm', 'announcement');
    const descriptionAI = useFormFields('aiField', data, setData, errors, 'create', 'description', 'Description', 'hrm', 'announcement');

    const submit = (e: React.FormEvent) => {
        e.preventDefault();
        post(route('rotas.announcements.store'), {
            onSuccess: () => {
                onSuccess();
            }
        });
    ...
    return (
        <DialogContent>
            <DialogHeader>
                <DialogTitle>{t('Create Announcement')}</DialogTitle>
                <DialogDescription>
                    {t('Create a new announcement to communicate with your team members.')}
                </DialogDescription>
            </DialogHeader>

...
class StoreRotasAvailabilityRequest extends FormRequest
{
    ...
    private function validateSameDateAvailability(Validator $validator): void
    {
        ...
        // Check for overlapping date ranges for same employee
        if ($startDate && $endDate && $employeeId) {
            $existingAvailability = RotasAvailability::where('employee_id', $employeeId)

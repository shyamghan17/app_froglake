...
class StorePhotoStudioCustomPageRequest extends FormRequest
{
    ...
    public function rules(): array
    {
        return [
            ...
            'slug'               => 'required|string|max:50|unique:photo_studio_custom_pages,slug,NULL,id,created_by,' . creatorId(),
        ];
    }

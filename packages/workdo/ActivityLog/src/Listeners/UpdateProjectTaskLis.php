...
class UpdateProjectTaskLis
{
    public function handle(UpdateProjectTask $event)
    {
        if (Module_is_active('ActivityLog')) {
            ...
            $activity['description'] = __('Task ') . $projectTask->title . __(' updated in project ') . $project->name . __(' by the ');

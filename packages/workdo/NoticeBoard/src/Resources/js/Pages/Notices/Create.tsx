...
import { CreateNoticeProps, CreateNoticeFormData } from './types';
import { useState, useEffect } from 'react';
import { isPackageActive } from '@/utils/helpers';

export default function Create({ onSuccess }: CreateNoticeProps) {
    ...
    const { data, setData, post, processing, errors } = useForm<CreateNoticeFormData>({
        title: '',
        description: '',
        attachments: [],
    ...
    const submit = (e: React.FormEvent) => {
        ...
        setDescriptionError('');
        post(route('notice-board.notices.store'), {
            onSuccess: () => onSuccess(),
        });
    };

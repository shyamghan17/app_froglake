                    ...
                    <div className="p-1 pl-1">
                        <div className="grid grid-cols-2 gap-x-8 gap-y-2 mb-4">
                            ...
                            <div className="flex justify-between">
                                ...
                                <span>{payrollEntry.employee?.bank_identifier_code || 'N/A'}</span>
                            </div>
                        </div>
                        ...
                        <div className="mt-2 space-y-2">
                            <div className="px-3 py-3 flex justify-between items-center">
                                <span><span className="font-bold">{t('Gross Pay')}</span> ({t('Basic + Allowances + Overtimes - Leave Deductions')})</span>
                                <span className="font-bold">{formatCurrency(payrollEntry.gross_pay)}</span>
                            </div>
                            <div className="px-3 py-3 flex justify-between items-center">
                                <span><span className="font-bold">{t('Net Pay')}</span> ({t('Gross - Deductions')})</span>

                                    ...
                                    <Tooltip delayDuration={0}>
                                        <TooltipTrigger asChild>
                                             <Button variant="ghost" size="sm" asChild className="h-8 w-8 p-0 text-orange-600 hover:text-orange-700">
                                                <a href={getImagePath(ackItem.document?.document)} download>
                        ...
                        <div className="overflow-auto max-h-[70vh] p-6">
                                            ...
                                            <div className="p-4 bg-gradient-to-r from-primary/5 to-transparent border-b flex-shrink-0">
                                                <div className="flex items-center gap-3">
                                                    ...
                                                    <div className="min-w-0 flex-1">
                                                        <h3 className="font-semibold text-sm text-gray-900">{acknowledgment.employee?.name || '-'}</h3>
                                                    </div>
                                                </div>
                                            </div>
                            ...
                            <div className="flex justify-end gap-1 p-3 border-t bg-gray-50/50 flex-shrink-0 mt-auto">
                                <TooltipProvider>
                                        ...
                                        {auth.user?.permissions?.includes('download-acknowledgment') && acknowledgment.document?.document && acknowledgment.status === 'acknowledged' && (
                                            <Tooltip delayDuration={300}>
                                                <TooltipTrigger asChild>
                                                    <Button variant="ghost" size="sm" onClick={() => {
                                                        const link = document.createElement('a');
                                                        link.href = getImagePath(acknowledgment.document?.document);
                                                        link.download = acknowledgment.document?.document?.split('/').pop() || acknowledgment.document?.title || 'document';
                                                        link.click();
                                        ...
                                        {auth.user?.permissions?.includes('view-acknowledgments') && (
                                            <Tooltip delayDuration={300}>
                                                <TooltipTrigger asChild>
                                                    <Button variant="ghost" size="sm" onClick={() => setViewingItem(acknowledgment)} className="h-8 w-8 p-0 text-green-600 hover:text-green-700">
                                                        <Eye className="h-4 w-4" />
                                                    </Button>
                                                </TooltipTrigger>
                                                <TooltipContent>
                                        ...
                                        {auth.user?.permissions?.includes('edit-acknowledgments') && (
                                            <Tooltip delayDuration={300}>
                                                <TooltipTrigger asChild>
                                                    <Button variant="ghost" size="sm" onClick={() => openModal('edit', acknowledgment)} className="h-8 w-8 p-0 text-blue-600 hover:text-blue-700">
                                                        <EditIcon className="h-4 w-4" />
                                                    </Button>
                                                </TooltipTrigger>
                                                <TooltipContent>

...
export default function CompanyDashboard({ message, bookingUrl, stats, recentAppointments, chartData, calendarAppointments }: CompanyDashboardProps) {
    ...
    return (
        <AuthenticatedLayout
            ...
            pageTitle={t('Beauty Spa Dashboard')}
        >
            <Head title={t('Beauty Spa Dashboard')} />
                    ...
                    <div className="bg-gradient-to-r from-primary/90 to-primary/70 rounded-lg p-6 text-white relative overflow-hidden" style={{ minHeight: '200px' }}>
                        ...
                        <div className="flex items-center justify-between relative z-10 h-full">
                            <div className="flex-1 pr-6">
                                <h2 className="text-3xl font-bold mb-3">{t('Welcome to Beauty Spa')}</h2>
                                <p className="text-white/80 mb-3 text-lg">{t('Manage your beauty spa appointments and services efficiently.')}</p>
                                <p className="text-white/70 mb-4 text-sm">{t('Track bookings, manage staff, and grow your beauty business all in one place.')}</p>
                                {bookingUrl && (
                ...
                {stats && (
                    <div className="grid grid-cols-2 gap-4">
                        ...
                        <Card className="bg-gradient-to-r from-green-50 to-green-100 border-green-200 cursor-pointer" onClick={() => router.visit(route('beauty-spa-management.booking-order.index'))}>
                            ...
                            <CardContent>
                                <div className="text-2xl font-bold text-green-700">{stats.completeAppointments}</div>
                            </CardContent>
                        </Card>
                        ...
                        <Card className="bg-gradient-to-r from-orange-50 to-orange-100 border-orange-200 cursor-pointer" onClick={() => router.visit(route('beauty-spa-management.booking-order.index'))}>
                            ...
                            <CardContent>
                                <div className="text-2xl font-bold text-orange-700">{stats.pendingAppointments}</div>
                            </CardContent>
                        </Card>
                        <Card className="bg-gradient-to-r from-purple-50 to-purple-100 border-purple-200 cursor-pointer" onClick={() => router.visit(route('beauty-spa-management.beauty-bookings.index'))}>
                            <CardHeader className="flex flex-row items-center justify-between space-y-0 pb-2">
